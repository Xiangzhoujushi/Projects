...
var themes = {
	...
	children:[
		...
		{name:"warfare",value:2,
			children:[
				{name:9,value:1},
				{name:16,value:1}
			]
		},
		{name:"family",value:13,
			children: [
				{name:3,value:1},
				{name:4,value:1},
				{name:9,value:1},
...
function setUpThemesPanel(panelID){
	themesCategories = [
		{name:'nature',chinese:'自然',subject:'things'},
		{name:'artifiact',chinese:'物件',subject:'things'},
		{name:'social',chinese:'社交',subject:'affairs'},
		{name:'politics',chinese:'政治',subject:'affairs'},
		{name:'warfare',chinese:'军事',subject:'affairs'},
		{name:'family',chinese:'家事',subject:'affairs'},
		{name:'mindset',chinese:'心态',subject:'ideas'},
		{name:'emotion',chinese:'情感',subject:'ideas'},
		{name:'senses',chinese:'感官',subject:'ideas'},
	]
	...
	.enter().append('text')
	.text(function(d){
		return d.subject+'-'+d.name+' '+d.chinese
	})
	.attr('x',
		function(d,i){
			return 30
