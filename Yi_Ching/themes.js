...
function setUpThemesPanel(panelID){
	themesCategories = [
		{name:'nature',chinese:'自然'},
		{name:'artifiact',chinese:'物件'},
		{name:'social',chinese:'社交'},
		{name:'politics',chinese:'政治'},
		{name:'wafare',chinese:'军事'},
		{name:'family',chinese:'家事'},
		{name:'mindset',chinese:'心态'},
		{name:'emotion',chinese:'情感'},
		{name:'senses',chinese:'感官'},
	]
